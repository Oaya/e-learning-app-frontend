...
const StudentSessionsPage = lazy(() => import("../features/student/sessions/pages/SessionsPage"));
const StudentHomeworkPage = lazy(() => import("../features/student/homework/pages/HomeworkPage"));
const StudentGoalsPage    = lazy(() => import("../features/student/goals/pages/GoalsPage"));
const StudentRecordingsPage = lazy(() => import("../features/student/recordings/pages/RecordingsPage"));
