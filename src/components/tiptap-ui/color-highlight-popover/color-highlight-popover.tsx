...
import { TEXT_COLORS } from "@/components/tiptap-ui/text-color-button";
import { ButtonGroup } from "@/components/tiptap-ui-primitive/button-group";
import { LuBan, LuHighlighter } from "react-icons/lu";

// Reuse the text color palette so highlight swatches match text colors.
const DEFAULT_HIGHLIGHT_COLORS: HighlightColor[] = TEXT_COLORS.map(
  ({ label, value }) => ({
    label,
    value,
    colorValue: value,
...
>(({ className, children, ...props }, ref) => (
  <Button
    ...
    {...props}
  >
    {children ?? <LuHighlighter className="tiptap-button-icon" />}
  </Button>
));
