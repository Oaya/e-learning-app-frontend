  ...
  ({ className, children, ...props }, ref) => {
    return (
      <Button
        ...
        {...props}
      >
        {children || <LuLink className="tiptap-button-icon" />}
      </Button>
    );
  },
);
        ...
        <CardItemGroup orientation="horizontal">
          ...
          <ButtonGroup>
            <Button
              ...
              variant="ghost"
            >
              <LuCornerDownLeft className="tiptap-button-icon" />
            </Button>
          </ButtonGroup>
          ...
          <ButtonGroup>
            <ButtonGroup>
              <Button
                ...
                variant="ghost"
              >
                <LuExternalLink className="tiptap-button-icon" />
              </Button>
            </ButtonGroup>
            ...
            <ButtonGroup>
              <Button
                ...
                variant="ghost"
              >
                <LuTrash className="tiptap-button-icon" />
              </Button>
            </ButtonGroup>
          </ButtonGroup>
        </CardItemGroup>
